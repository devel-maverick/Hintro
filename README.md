...
|-------|------------------------|---------------------------|
| ![Login](screenshots/login-desktop.png) | ![Empty](screenshots/dashboard-empty.png) | ![Filled](screenshots/dashboard-filled.png) |

| Feedback Modal | Feedback History |
|----------------|-----------------|
| ![Feedback](screenshots/feedback-modal.png) | ![History](screenshots/feedback-history.png) |

### Mobile

| Dashboard | Navigation | Feedback History |
|-----------|-----------|-----------------|
| ![Mobile Dashboard](screenshots/dashboard-mobile.png) | ![Mobile Nav](screenshots/nav-mobile.png) | ![Mobile History](screenshots/history-mobile.png) |
